        ...
        <>
          ...
          >
            ...
            <div className="px-5 pb-8">
              ...
              <button
                onClick={handlePay}
                className="w-full py-3.5 rounded-xl bg-foreground text-background font-display font-bold text-sm flex items-center justify-center gap-2 mb-3 hover:opacity-90 transition-opacity"
              >
